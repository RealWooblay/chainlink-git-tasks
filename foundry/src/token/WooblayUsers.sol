...
import {IWooblayUsers} from "./IWooblayUsers.sol";

contract WooblayUsers is ERC721, EIP712, ERC721Votes, Ownable, IWooblayUsers {
    ...
    constructor(
        ...
        ERC721("Wooblay Users", "WOOBLAYUSERS")
        EIP712("Wooblay Users", "1")
